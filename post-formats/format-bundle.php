<?php
/*
Single Post Template: Single - Bundle
This wil display the bundle embed at the top of the post, instead of an image
*/
?>

<?php $bundleurl = get_post_meta( $post->ID, '_btm_bundle_url', true ); ?>
        ...
        <div id="main" class="single-main clearfix" role="main">
          ...
          <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
              <div class="hidden-xs hidden-sm">
                <iframe src="<?php echo $bundleurl ?>" 
                height="640" width="940" allowfullscreen="true" frameborder="no" scrolling="no"></iframe>
              </div>
                <div class="hidden-md hidden-lg">
                  <a href="<?php echo $bundleurl ?>" target="_blank">
                  ...
                  <div class="mobile-bundle">
                    <span>View the Bundle</span>
                  </div>
                  </a>
                </div>
