		...
		**/
		...
		public function setSections() {
			...
			$this->sections[] = array(
				...
				'fields' => array (
					array(
						...
						'subtitle' => __('Select category for mid featured section on homepage', 'redux-framework-demo'),
          ...
          array(
            ...
            'type' => 'media', 
            'url'=> true,
            'title' => __('Favicon PNG', 'redux-framework-demo'),
            'compiler' => 'true',
            'desc'=> __('Theme favicon in PNG format', 'brew-framework'),
            ),
          array(
            'id'=>'themeFavICO',
            'type' => 'media', 
            ...
            'compiler' => 'true',
            'desc'=> __('Theme favicon in ICO format', 'brew-framework'),
            ),
          array(
            'id'=>'themecss',
            'type' => 'text',
         ...
         array(
            'id'        => 'themehello',
            'type'      => 'switch',
            'title'     => __('Turn on email collection', 'redux-framework-demo'),
            'subtitle'  => __('Turn the modal on or off for a slide in modal.', 'redux-framework-demo'),
